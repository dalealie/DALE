...
class Command(BaseCommand):
    ...
    def create_collection(self):
        collection1 = Collection(card=PokemonCard.objects.get(name="Charmeleon"), trainer=Trainer.objects.get(name="Gold"), collection_date="1997-04-01")
        collection2 = Collection(card=PokemonCard.objects.get(name="Pancham"), trainer=Trainer.objects.get(name="Silver"), collection_date="1999-06-27")
